%%Day_diff
%The function day_diff  takes four scalar positive integer inputs, month1, 
%day1, month2, day2 which represents the birthdays of two children who were 
%born in 2015 and returns a positive integer which would make dd equal 2. 
